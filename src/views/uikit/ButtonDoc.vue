...
// Se define un array de booleanos para controlar el estado de carga de cada botón.
// Se ha agregado un elemento adicional para cubrir el caso en el template.
    ...
    <div class="md:w-1/2">
      <div class="card flex flex-col gap-4">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <Button label="Bookmark" icon="pi pi-bookmark" iconPos="right" class="mr-2 mb-2" />
        </div>
      </div>
      <div class="card flex flex-col gap-4">
